import Vue from 'vue'
import CardNumber from '../src/components/card-inputs/CardNumber.vue'


describe('CardNumber', () => {

  it('Sets the correct default data', () => {
    expect(typeof CardNumber.data).toBe('function');
    const defaultData = CardNumber.data();
  ...
  it('Card have a valid flag', () => {
    const Constructor = Vue.extend(CardNumber);
